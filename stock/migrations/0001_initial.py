    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('web_id', models.UUIDField(default=uuid.UUID('6756b044-5d5b-40ff-9e37-b8cc6a6dd043'), editable=False, help_text='format: required, unique', unique=True, verbose_name='product website ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_stock', models.IntegerField(default=0, help_text='format: required, default-0', verbose_name='units/qty of stock')),
